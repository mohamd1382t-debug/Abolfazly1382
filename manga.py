...
# این مقدار همیشه همینه؛ دیگه از remove_object.py گرفته نمی‌شه، پس هر مقداری این‌جا
# بذاریم واقعاً همون اعمال می‌شه، حتی اگه فایل remove_object.py رو سیستم وجود داشته باشه.
_LAMA_MASK_EXPAND_RATIO = 0.12
